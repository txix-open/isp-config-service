...
### v3.10.0
* событие `MODULE_READY` теперь может быть обработано несколько раз, обновляя полученные данные об инстансе модуля
### v3.9.3
...
## v3.7.0
* добавлены rqlite-автобэкапы и прокси-эндпоинт `/backup` для создания резервных копий
* изменен таймаут ожидания лидера с 30 до 180 секунд
* исправлены потенциальные race conditions
* добавлен параметр периодической оптимизации sqlite `AutoOptimizeInterval: 23h`
* обновлены зависимости
## v3.6.0
